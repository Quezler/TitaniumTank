...
function get_server_data()
{
	...
	http_get_async("http://73.233.9.103:27000/TitaniumTank/servers.csv", build_server_table);
}
...
function build_server_table(csv_data)
{
	...
	for (var i = 1; i < rows.length; i++)
	{
		...
		if (is_passworded === 1)
		{
			table.push('<tr><td><p style="text-align:center;"><img src="../img/lock.png"/></p></td>');
		}
		else
		{
			table.push('<tr><td></td>');
